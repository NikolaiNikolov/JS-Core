...
module.exports = function (_chai, util) {
   ...
   *
   * Executes an expression and check expectations. Throws AssertionError for reporting if tests doesn't pass.
   *
   * @name assert
...
module.exports = function (chai, util) {
   ...
   *
   * Write your own tests expressions.
   *
   *     assert('foo' !== 'bar', 'foo is not bar');
   *     assert(Array.isArray([]), 'empty arrays are arrays');
   *
   * @param {Mixed} expression to tests for truthiness
 ...
 * If the message contains the String or passes the RegExp tests,
